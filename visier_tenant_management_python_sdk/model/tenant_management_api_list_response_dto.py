...
class TenantManagementAPIListResponseDTO(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class tenants(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TenantManagementAPIGetResponseDTO']:
                        return TenantManagementAPIGetResponseDTO
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['TenantManagementAPIGetResponseDTO'], typing.List['TenantManagementAPIGetResponseDTO']],
                ...
                def __getitem__(self, i: int) -> 'TenantManagementAPIGetResponseDTO':
